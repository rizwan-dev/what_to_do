...
const String TWITTER_URL = "https://twitter.com/rizwan";
const String FACEBOOK_URL = "https://www.facebook.com/rizwan";
const String GITHUB_URL = "https://github.com/rizwan-dev";
const String PROJECT_URL = "https://github.com/rizwan/WhatTodo";
const String ISSUE_URL = "https://github.com/rizwan/WhatTodo/issues";
const String README_URL =
    "https://github.com/riztech-dev/WhatTodo/blob/master/README.md";
const String EMAIL_URL =
    "mailto:<riztech.dev@gmail.com>?subject=WhatTodo%20Query&body=Hi";
